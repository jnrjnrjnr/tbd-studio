...
export const Navbar = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-sand-50/95 backdrop-blur-md shadow-sm' : 'bg-transparent'}`}>
      <div className="container-custom flex items-center justify-between h-14">
        <a href="#" className="text-xl font-display font-medium text-earth-dark tracking-tight">
          TBD Studio
        </a>
        ...
        <nav className="hidden md:flex items-center gap-5">
          ...
          <Button asChild size="sm" className="bg-earth-dark hover:bg-earth-darker text-sand-50 font-medium ml-2">
            <a href="#get-started">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-sand-50 border-t border-sand-300/30 shadow-md">
          <div className="container-custom py-3 flex flex-col">
            ...
            <Button asChild className="mt-3 bg-earth-dark hover:bg-earth-darker h-8 text-sm w-full">
