...
export const Footer = () => {
  return (
    <footer className="bg-dark py-14 border-t border-border/50">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <h3 className="text-xl font-bold mb-4">TBD Studio</h3>
            <p className="text-gray-400 mb-4">Modern websites for small businesses, delivered in 24 hours.</p>
          </div>
        ...
        <div className="border-t border-border/50 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">© {new Date().getFullYear()} TBD Studio. All rights reserved.</p>
